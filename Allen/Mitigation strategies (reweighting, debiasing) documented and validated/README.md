# Debiasing & Mitigation Strategies Evaluation – Evidence Collection & Automated ADA Scoring  
*(L4 Fairness Branch: “Mitigation strategies (reweighting, debiasing) documented and validated”)*

This repository contains all files required to reproduce the evidence-collection and automated scoring workflow for evaluating **“Mitigation strategies (reweighting, debiasing) documented and validated”**, an **L4 fairness branch** in the AI Ethics Index measurement project.
...
Each model (GPT-4o and Ollama-Mistral) produces a **1500–2500-word, audit-ready ADA evidence report** covering the following debiasing / mitigation dimensions:
...
Each criterion is rated **0–5**, using strict grading rules:
...
- Full audit trail from evidence → scoring → combined results  
